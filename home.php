  ...
  <div class="container">
    <form action="add.php" method='POST'>
        <div class="form-group">
            <textarea class="form-control" name="entry" rows="5" cols="30" placeholder="Add Your thoughts"></textarea> 
        </div>
        <!-- <textarea name="entry" id="" cols="30" rows="100" placeholder="Add Your thoughts"></textarea> -->
        <div class="form-group">
            <button name="login" class="w-100 btn btn-lg btn-primary" type="submit">Save</button>
        </div>
